...
class PersonDtoTest {
    ...
    @Test
    public void testShouldKnowHowToConvertDtoToString() {
    ...
    @Test
    public void testShouldKnowHowTwoDtoDoNotHaveSameStringLiteralWhenDeclaredDifferently() {
        final PersonDto personDto = new PersonDto();
        final PersonDto anotherPersonDto = new PersonDto();
    ...
    @Test
    public void testShouldAppropriatelyTestTheGetterAndSetters() {
        final PersonDto personDto = new PersonDto();
